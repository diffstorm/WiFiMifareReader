...
#define LOGi(z, i)  DBG_LOG(z, (const char *)__func__, (const char *)__LOCATION, (int *)&(i), NULL, NULL, NULL, (int)0)
#define LOGf(z, f)  DBG_LOG(z, (const char *)__func__, (const char *)__LOCATION, NULL, (float *)&(f), NULL, NULL, (int)0)
#define LOGd(z, d)  DBG_LOG(z, (const char *)__func__, (const char *)__LOCATION, NULL, NULL, (double *)&(d), NULL, (int)0)
#define LOGh(z, h)  DBG_LOG(z, (const char *)__func__, (const char *)__LOCATION, NULL, NULL, NULL, (char *)h, (int)sizeof(h))
#else
